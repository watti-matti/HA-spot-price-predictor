...
[![Version](https://img.shields.io/badge/version-2.5.4-blue.svg)](https://github.com/watti-matti/HA-spot-price-predictor/releases/tag/v2.5.4)
...
- [studies/results/V2_5_4_RELEASE_NOTES.md](studies/results/V2_5_4_RELEASE_NOTES.md) — **v2.5.4 (CURRENT)** — Per-sensor seasonality audit; per-input decomposition depths set (wind: hour+week per user hint; prices: hour+day+week; weather: hour+week)
