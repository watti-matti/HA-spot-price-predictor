...
[![Version](https://img.shields.io/badge/version-2.5.7-blue.svg)](https://github.com/watti-matti/HA-spot-price-predictor/releases/tag/v2.5.7)
...
- [studies/results/V2_5_7_RELEASE_NOTES.md](studies/results/V2_5_7_RELEASE_NOTES.md) — **v2.5.7 (CURRENT)** — Smoother per-week seasonal vectors: weather inputs refit on 8.3 y window with circular smoothing; cloud P_week noise −28 %
