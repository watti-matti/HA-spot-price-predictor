...
[![Version](https://img.shields.io/badge/version-2.5.10-blue.svg)](https://github.com/watti-matti/HA-spot-price-predictor/releases/tag/v2.5.10)
...
- [studies/results/V2_5_10_RELEASE_NOTES.md](studies/results/V2_5_10_RELEASE_NOTES.md) — **v2.5.10 (CURRENT)** — Layer 3 (AR(1) on Ridge residual) + wind test. AR φ=0.93 lifts day-ahead CVaR +6→+25%, wind cuts MAE 39→29 EUR/MWh at all horizons
