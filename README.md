...
[![Version](https://img.shields.io/badge/version-2.5.6-blue.svg)](https://github.com/watti-matti/HA-spot-price-predictor/releases/tag/v2.5.6)
...
- [studies/results/V2_5_6_RELEASE_NOTES.md](studies/results/V2_5_6_RELEASE_NOTES.md) — **v2.5.6 (CURRENT)** — Hedge-gated input sweep at 24/48/168 h horizons; 7-day verdict: `(Y_fi_lag168, is_workday)` → +16% CVaR reduction. Day-ahead achieves +41%.
