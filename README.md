...
[![Version](https://img.shields.io/badge/version-2.5.15-blue.svg)](https://github.com/watti-matti/HA-spot-price-predictor/releases/tag/v2.5.15)
...
- [studies/results/V2_5_15_HOURLY_DTACI_ENHANCEMENTS.md](studies/results/V2_5_15_HOURLY_DTACI_ENHANCEMENTS.md) — **v2.5.15 (CURRENT)** — Three hourly DtACI extensions: bias corrector (closes systematic-bias loop), fan-chart calibrator (realised coverage 0.5→0.52, 0.9→0.92), refit monitor (14-day drift trigger).
