...
[![Version](https://img.shields.io/badge/version-2.5.12-blue.svg)](https://github.com/watti-matti/HA-spot-price-predictor/releases/tag/v2.5.12)
...
- [studies/results/V2_5_12_RELEASE_NOTES.md](studies/results/V2_5_12_RELEASE_NOTES.md) — **v2.5.12 (CURRENT)** — Sigmoid turbine power curve replaces v2.5.11 cubic. Sigmoid ties raw Y_wind on MAE, slightly better CVaR (+14.0% vs +13.5% at 24h)
