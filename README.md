...
[![Version](https://img.shields.io/badge/version-2.5.17-blue.svg)](https://github.com/watti-matti/HA-spot-price-predictor/releases/tag/v2.5.17)
...
- [studies/results/V2_5_17_DK_FULL_RANGE.md](studies/results/V2_5_17_DK_FULL_RANGE.md) — **v2.5.17 (CURRENT)** — Extended D(k) to full i=0..23 range; v2.6.0 schema locked. R² ≥ 0.95 at EVERY index; cheap_23 = peak_23 = daily mean by definition (verified to 1e-13).
