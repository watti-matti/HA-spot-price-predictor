...
[![Version](https://img.shields.io/badge/version-2.5.5-blue.svg)](https://github.com/watti-matti/HA-spot-price-predictor/releases/tag/v2.5.5)
...
- [studies/results/V2_5_5_RELEASE_NOTES.md](studies/results/V2_5_5_RELEASE_NOTES.md) — **v2.5.5 (CURRENT)** — De-seasonalized input infrastructure: seasonal_decomposition module + builder + shipped 22 KB artifact + 14 tests
